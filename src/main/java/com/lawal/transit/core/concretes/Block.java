...
public class Block extends NamedEntity {
    ...
    public Station getStation (Direction borderOrientation) {
        switch (borderOrientation) {
            case NORTH:
                return Stations.INSTANCE.search(stations.get(Direction.NORTH));
            case EAST:
                return Stations.INSTANCE.search(stations.get(Direction.EAST));
            case SOUTH:
                return Stations.INSTANCE.search(stations.get(Direction.SOUTH));
            case WEST:
                return Stations.INSTANCE.search(stations.get(Direction.WEST));
            default:
