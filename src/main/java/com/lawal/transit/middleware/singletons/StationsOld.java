...
public class StationsOld extends EntitySingletonList implements Iterable<Station> {
    private static final long serialVersionUID = 1L;
    private ArrayList<Station> stations = new ArrayList<Station>();
    private static StationsOld singleton = null;
    ...
    public static StationsOld getInstance () {
        if (singleton == null) {
            singleton = new StationsOld();
        }
        return singleton;
    } // close getInstance
