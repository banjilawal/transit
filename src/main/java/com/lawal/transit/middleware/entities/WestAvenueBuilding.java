...
public class WestAvenueBuilding extends AvenueBuilding {

    public WestAvenueBuilding (int id, String name, int blockId, Avenue avenue) {
        super(id, name, blockId, avenue, Direction.WEST);
    }
} // end class WestAvenueBuilding
...
public class WestAvenueBuilding extends AvenueBuilding {
    public static Direction BUILDING_ORIENTATION = Direction.WEST;
    public WestAvenueBuilding (int id, String name, int blockId, Avenue blockAvenue) {
