...
//
///**
// * @param requirements private int stationRatio;    private int stationCursor;    private final RoadIdentifier label;
// */
...
//            .build();
//
//    public AvenueCreator stationRatio (int stationRatio) {
//        this.stationRatio = stationRatio;
//        return this;
//    }
...
////                .leftCurb(new Curbside.Builder().key(new CurbsideMark(requirements.roadLabel(), Avenue.LEFTWARD_TRAFFIC_DIRECTION)).blocks(new Blocks()).stations(new Stations()).build())
////                .rightCurb(new Curbside.Builder().key(new CurbsideMark(requirements.roadLabel(), Avenue.RIGHTWARD_TRAFFIC_DIRECTION)).blocks(new Blocks()).stations(new Stations()).build())
...
//    }
//
//    private Curbsideable curbside(int startingPlaceName, int startingStationName, Direction trafficDirection) throws Exception {
...
//            .marker(new CurbsideMark(requirements.roadLabel(), trafficDirection))
//            .build();
