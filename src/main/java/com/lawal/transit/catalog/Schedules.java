...
//    }
//
//    public HashMap<String, ArrayList<Trackable>> selectByTime (FormattedAddress address,  LocalDateTime time, long minuteRange) {
//        HashMap<String, ArrayList<Trackable>> results = new HashMap<>();
//        for (TimeTable timeTable : list) {
//            if (timeTable.getEntries().positionExists(address)) {
//                ArrayList<Trackable> entries = timeTable.getEntries().selectByTime(time, minuteRange);
