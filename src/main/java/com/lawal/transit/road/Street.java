...
import com.lawal.transit.buildings.Buildings;
...
public final class Street implements Road {
    ...
    public static final Orientation RIGHT_SIDE_TRAFFIC_DIRECTION = Orientation.NORTH;
    public static final Orientation LEFT_SIDE_TRAFFIC_DIRECTION = Orientation.SOUTH;
    ...
    public Street (int id, String name) throws Exception {
        this(id, name, 0, 0);
    }

    public Street (int id, String name, int numberOfRightLanes, int numberOfLeftLanes) {
        this.identifier = new RoadIdentifier(id, name, RoadCategory.STREET);
        this.rightLanes = new TrafficLanes(RIGHT_SIDE_TRAFFIC_DIRECTION);
        for (int index = 0; index < numberOfRightLanes; index++) {
            rightLanes.addLane();
        }
        this.leftLanes = new TrafficLanes(LEFT_SIDE_TRAFFIC_DIRECTION);
    ...
    public String toString () {
        return identifier.getName() + " " + identifier.getCategory().print();
    }
}
